...
//      version:		2007Q2V1
//      comment:		
//      configuration:	 -instname "sram_sp_128x64" -words 128 -bits 64 -frequency 1 -ring_width 2.0 -mux 1 -write_mask on -wp_size 8 -top_layer "met5-9" -power_type rings -horiz met3 -vert met2 -redundancy off -rcols 1 -rrows 0 -bmux off -ema on -cust_comment "" -bus_notation on -left_bus_delim "[" -right_bus_delim "]" -pwr_gnd_rename "VDD:VDD,VSS:VSS" -prefix "" -pin_space 0.0 -name_case upper -check_instname on -diodes on -inside_ring_type VSS -drive 4 -asvm off -corners ff_1.1_-40.0,ff_1.1_125.0,tt_1.0_25.0,ss_0.9_125.0
//
//      Verilog model for Synchronous Single-Port Register File
//
//      Instance Name:              sram_sp_128x64
//      Words:                      128
//      Bits:                       64
//      Mux:                        1
//      Drive:                      4
...
//      Test Muxes                  Off
//
//      Creation Date:  2026-03-09 21:05:10Z
//      Version: 	2007Q2V1
//
...
`celldefine
  module sram_sp_128x64_rf (
   ...
   reg                      LAST_NOT_CEN;
   reg [WEN_WIDTH-1:0]      LAST_NOT_WEN;
		...
		begin
		   ...
		   begin
			...
			begin
				...
				else if ((status[n] === 1'b0) & (other_status[n] === 1'b1) & contention)
				  begin
				     tmpdata[n] = 1'bx;
			             other_q[n] = 1'bx;
				  end
   ...
   assign D_flag63 = !(_CEN || _WEN[63/8]);
   assign D_flag62 = !(_CEN || _WEN[31/4]);
   assign D_flag61 = !(_CEN || _WEN[61/8]);
   assign D_flag60 = !(_CEN || _WEN[15/2]);
   assign D_flag59 = !(_CEN || _WEN[59/8]);
   assign D_flag58 = !(_CEN || _WEN[29/4]);
   assign D_flag57 = !(_CEN || _WEN[57/8]);
   assign D_flag56 = !(_CEN || _WEN[7]);
   assign D_flag55 = !(_CEN || _WEN[55/8]);
   assign D_flag54 = !(_CEN || _WEN[27/4]);
   assign D_flag53 = !(_CEN || _WEN[53/8]);
   assign D_flag52 = !(_CEN || _WEN[13/2]);
   assign D_flag51 = !(_CEN || _WEN[51/8]);
   assign D_flag50 = !(_CEN || _WEN[25/4]);
   assign D_flag49 = !(_CEN || _WEN[49/8]);
   assign D_flag48 = !(_CEN || _WEN[6]);
   assign D_flag47 = !(_CEN || _WEN[47/8]);
   assign D_flag46 = !(_CEN || _WEN[23/4]);
   assign D_flag45 = !(_CEN || _WEN[45/8]);
   assign D_flag44 = !(_CEN || _WEN[11/2]);
   assign D_flag43 = !(_CEN || _WEN[43/8]);
   assign D_flag42 = !(_CEN || _WEN[21/4]);
   assign D_flag41 = !(_CEN || _WEN[41/8]);
   assign D_flag40 = !(_CEN || _WEN[5]);
   assign D_flag39 = !(_CEN || _WEN[39/8]);
   assign D_flag38 = !(_CEN || _WEN[19/4]);
   assign D_flag37 = !(_CEN || _WEN[37/8]);
   assign D_flag36 = !(_CEN || _WEN[9/2]);
   assign D_flag35 = !(_CEN || _WEN[35/8]);
   assign D_flag34 = !(_CEN || _WEN[17/4]);
   assign D_flag33 = !(_CEN || _WEN[33/8]);
   assign D_flag32 = !(_CEN || _WEN[4]);
   assign D_flag31 = !(_CEN || _WEN[31/8]);
   assign D_flag30 = !(_CEN || _WEN[15/4]);
   assign D_flag29 = !(_CEN || _WEN[29/8]);
   assign D_flag28 = !(_CEN || _WEN[7/2]);
   assign D_flag27 = !(_CEN || _WEN[27/8]);
   assign D_flag26 = !(_CEN || _WEN[13/4]);
   assign D_flag25 = !(_CEN || _WEN[25/8]);
   assign D_flag24 = !(_CEN || _WEN[3]);
   assign D_flag23 = !(_CEN || _WEN[23/8]);
   assign D_flag22 = !(_CEN || _WEN[11/4]);
   assign D_flag21 = !(_CEN || _WEN[21/8]);
   assign D_flag20 = !(_CEN || _WEN[5/2]);
   assign D_flag19 = !(_CEN || _WEN[19/8]);
   assign D_flag18 = !(_CEN || _WEN[9/4]);
   assign D_flag17 = !(_CEN || _WEN[17/8]);
   assign D_flag16 = !(_CEN || _WEN[2]);
   assign D_flag15 = !(_CEN || _WEN[15/8]);
   assign D_flag14 = !(_CEN || _WEN[7/4]);
   assign D_flag13 = !(_CEN || _WEN[13/8]);
   assign D_flag12 = !(_CEN || _WEN[3/2]);
   assign D_flag11 = !(_CEN || _WEN[11/8]);
   assign D_flag10 = !(_CEN || _WEN[5/4]);
   assign D_flag9 = !(_CEN || _WEN[9/8]);
   assign D_flag8 = !(_CEN || _WEN[1]);
   assign D_flag7 = !(_CEN || _WEN[7/8]);
   assign D_flag6 = !(_CEN || _WEN[3/4]);
   assign D_flag5 = !(_CEN || _WEN[5/8]);
   assign D_flag4 = !(_CEN || _WEN[1/2]);
   assign D_flag3 = !(_CEN || _WEN[3/8]);
   assign D_flag2 = !(_CEN || _WEN[1/4]);
   assign D_flag1 = !(_CEN || _WEN[1/8]);
   assign D_flag0 = !(_CEN || _WEN[0]);
